...
<html lang="pt-br">
    ...
    <body class="<?php echo $currentUserData['tema'];?>">
        ...
        <main class="Ho-Main mainSystem">
            ...
            <div class="modalBack">
                <form class="Re-registerChild postAuxilioModal" method="post" enctype="multipart/form-data">
                    <i class="bi bi-x closeModal" onclick="registerChildModal()"></i>
                    ...
                    <div class="Re-childInformations Re-registerSections close">
                        ...
                        <div class="Re-addChildBox close">
                            ...
                            <div class="Re-childBoxButtons">
                                ...
                                <button class="Re-confirmAddChild confirmBtn"> Confirmar </button>
                            </div>
                        </div>
                    </div>
                </form>
