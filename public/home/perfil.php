...
<body>
    ...
    <main>
        ...
        <section class="userArea">
            ...
            <a href="./perfil.php?deleteId=<?php echo $_SESSION['idUsuario'];?>&n=<?php echo $_SESSION['user'];?>">EXCLUIR
                CONTA</a>
            <br><br>
            <?php
                        }
            ...
            <form action="" method="post">
                ...
                <input type="text" placeholder="<?php echo "delete/".$_GET['deleteId']."/".$_GET['n']?>"
                    name="confirmaTexto"><br><br>
